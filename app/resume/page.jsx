...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "barhom1232003@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const Resume = () => {
  return (
    <motion.div
      ...
      className="min-h-[80vs] flex items-center justify-center py-12 xl:py-0 "
    >
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 gap-x-20 max-w-[620px] mx-auto xl:mx-0">
                  {about.info.map((field, index) => {
                    return (
                      ...
                      >
                        <span className="text-white/60">{field.fieldName}</span>
